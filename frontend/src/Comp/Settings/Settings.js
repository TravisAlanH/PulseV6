...
export default function Settings() {
  ...
  return (
    <div className="flex flex-col border-2 m-2">
      <div className="bg-[#F7F5F1] flex flex-row justify-start h-[3rem] items-center pl-6 text-lg font-bold">Settings @ {LocationName}</div>
      <div className="flex flex-col justify-items items-center w-full">
        {/* LOAD LOCAL STORAGE */}
        <div className="w-full">
          <label className={"text-xs font-bold  p-1 bg-[#F7F5F1] flex flex-col justify-center w-[8rem]"}>Name Convention</label>
          <div>
            <NamingCons />
          </div>
        </div>
        ...
        <div className="flex flex-row justify-start gap-6 px-6 w-[15rem]">
          <div className="py-2 flex flex-row">
            <label className={"text-xs font-bold  p-1 bg-[#F7F5F1] flex flex-col justify-center w-[8rem]"}>Clear Data</label>
            <button
              className="redButton"
              onClick={() => {
