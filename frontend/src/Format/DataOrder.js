const OrderData = {
  ...
  "Rack PDUs": ["# Operation *", "Object *", "Name *", "Make *", "Model *", "Location *", "Cabinet *", "Cabinet Side *", "Depth Position *", "U Position *", "Status *"],
  Assets: ["# Operation *", "Object *", "Name *", "Make *", "Model *", "Location *", "Cabinet *", "U Position *", "Asset Tag", "Rails Used *", "Orientation *", "Status *"],
  Blades: ["# Operation *", "Object *", "Name *", "Make *", "Model *", "Location *", "Cabinet *", "Chassis *", "Slot Position *", "Asset Tag", "Chassis Face *", "Status *"],
  ...
  SurveyGlobal: ["Key Holder Record", "Access Records", "Visitor Access Records", "Visitor Log Contains", "Visitor Log Retention", "Auto Expiring Badges", "Visitor Escort Required"],
  SurveyRoom: ["Room Number *", "GPS Coordinates *", "Area *", "Ceiling Type *", "Ceiling Condition *", "Floor Type *", "Floor Condition *", "Wall Type *", "Wall Condition *", "Cleanliness *", "Room Notes"],
...
export function sortObjectByTemplate(object, Step, Data) {
  ...
  if (Step === "Location") {
    let SurveyObject = { ...Data.SurveyGlobal[0], ...Data.SurveySite[0], ...Data.SurveyRoom[0], ...Data.SurveySecurity[0], ...Data.SurveySafety[0] };
    ...
    DataOrder = [...DataOrder, ...OrderData.SurveyGlobal, ...OrderData.SurveyRoom, ...OrderData.SurveySecurity, ...OrderData.SurveySite, ...OrderData.SurveySafety];
  }
